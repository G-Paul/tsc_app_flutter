...
class MenuTeachersDetailsScreen extends StatefulWidget {
  const MenuTeachersDetailsScreen({super.key});

  @override
  State<MenuTeachersDetailsScreen> createState() => _MenuTeachersDetailsScreenState();
}

class _MenuTeachersDetailsScreenState extends State<MenuTeachersDetailsScreen> {
  ...
  void getUserDetails() async {
    ...
    await db.collection('teachers').doc(user.uid).get().then((doc) {
      setState(() {
